...
\restrict DJ473HNJGl2fKtj4U80WSeoEc4fx3uqyulYTlbgieRMPVBleVPNKfaqfys9jzgC
...
CREATE TABLE public.roles (
    role text NOT NULL,
    CONSTRAINT roles_role_check CHECK ((role = ANY (ARRAY['user'::text, 'developer'::text, 'admin'::text])))
);
...
--
-- Name: app_versions app_versions_app_id_platform_version_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.app_versions
    ADD CONSTRAINT app_versions_app_id_platform_version_key UNIQUE (app_id, platform, version);
...
--
-- Name: reviews reviews_app_id_user_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.reviews
    ADD CONSTRAINT reviews_app_id_user_id_key UNIQUE (app_id, user_id);
...
--
-- Name: idx_reviews_app; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_reviews_app ON public.reviews USING btree (app_id);


--
-- Name: idx_versions_app_platform; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_versions_app_platform ON public.app_versions USING btree (app_id, platform);
...
--
-- Name: apps trg_apps_updated; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_apps_updated BEFORE UPDATE ON public.apps FOR EACH ROW EXECUTE FUNCTION public.set_updated_at();
...
--
-- Name: app_categories app_categories_app_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
ALTER TABLE ONLY public.app_categories
    ADD CONSTRAINT app_categories_category_id_fkey FOREIGN KEY (category_id) REFERENCES public.categories(id) ON DELETE CASCADE;
...
--
-- Name: apps apps_category_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.apps
    ADD CONSTRAINT apps_category_id_fkey FOREIGN KEY (category_id) REFERENCES public.categories(id);
...
ALTER TABLE ONLY public.apps
    ADD CONSTRAINT apps_publisher_id_fkey FOREIGN KEY (publisher_id) REFERENCES public.developers(id) ON DELETE CASCADE;


--
-- Name: developers developers_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.developers
    ADD CONSTRAINT developers_id_fkey FOREIGN KEY (id) REFERENCES public.profiles(id) ON DELETE CASCADE;


--
-- Name: app_versions fk_app_versions_apps; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.app_versions
    ADD CONSTRAINT fk_app_versions_apps FOREIGN KEY (app_id) REFERENCES public.apps(id) ON DELETE CASCADE;


--
-- Name: reviews fk_reviews_apps; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.reviews
    ADD CONSTRAINT fk_reviews_apps FOREIGN KEY (app_id) REFERENCES public.apps(id) ON DELETE CASCADE;


--
-- Name: screenshots fk_screenshots_apps; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.screenshots
    ADD CONSTRAINT fk_screenshots_apps FOREIGN KEY (app_id) REFERENCES public.apps(id) ON DELETE CASCADE;


--
-- Name: installs installs_app_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.installs
    ADD CONSTRAINT installs_app_id_fkey FOREIGN KEY (app_id) REFERENCES public.apps(id) ON DELETE CASCADE;


--
-- Name: installs installs_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.installs
    ADD CONSTRAINT installs_user_id_fkey FOREIGN KEY (user_id) REFERENCES auth.users(id) ON DELETE SET NULL;


--
-- Name: installs installs_version_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.installs
    ADD CONSTRAINT installs_version_id_fkey FOREIGN KEY (version_id) REFERENCES public.app_versions(id) ON DELETE SET NULL;
...
--
-- Name: profiles profiles_role_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.profiles
    ADD CONSTRAINT profiles_role_fkey FOREIGN KEY (role) REFERENCES public.roles(role);


--
-- Name: reviews reviews_app_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: screenshots screenshots_app_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.screenshots
    ADD CONSTRAINT screenshots_app_id_fkey FOREIGN KEY (app_id) REFERENCES public.apps(id) ON DELETE CASCADE;
...
--
-- Name: apps apps_owner_full; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY apps_owner_full ON public.apps USING ((publisher_id = auth.uid())) WITH CHECK ((publisher_id = auth.uid()));


--
-- Name: apps apps_public_read_listed; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY apps_public_read_listed ON public.apps FOR SELECT USING ((is_listed = true));


--
-- Name: developers dev_select_self; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY dev_select_self ON public.developers FOR SELECT USING ((auth.uid() = id));


--
-- Name: developers dev_update_self; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY dev_update_self ON public.developers FOR UPDATE USING ((auth.uid() = id)) WITH CHECK ((auth.uid() = id));


--
-- Name: developers dev_upsert_self; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY dev_upsert_self ON public.developers USING ((auth.uid() = id)) WITH CHECK ((auth.uid() = id));
...
--
-- Name: installs; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.installs ENABLE ROW LEVEL SECURITY;

--
-- Name: installs installs_app_owner_select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY installs_app_owner_select ON public.installs FOR SELECT USING ((EXISTS ( SELECT 1
   FROM public.apps a
  WHERE ((a.id = installs.app_id) AND (a.publisher_id = auth.uid())))));


--
-- Name: installs installs_user_read_write; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY installs_user_read_write ON public.installs USING ((auth.uid() = user_id)) WITH CHECK ((auth.uid() = user_id));
...
--
-- Name: app_versions public read app_versions; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "public read app_versions" ON public.app_versions FOR SELECT USING (true);


--
-- Name: installs public read installs; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: app_versions public read versions; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: developers public_select_developers; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY public_select_developers ON public.developers FOR SELECT USING (true);
...
--
-- Name: reviews reviews_author_delete; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY reviews_author_delete ON public.reviews FOR DELETE USING ((auth.uid() = user_id));


--
-- Name: reviews reviews_author_update_delete; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY reviews_author_update_delete ON public.reviews FOR UPDATE USING ((auth.uid() = user_id)) WITH CHECK ((auth.uid() = user_id));


--
-- Name: reviews reviews_author_write; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY reviews_author_write ON public.reviews FOR INSERT WITH CHECK ((auth.uid() = user_id));
...
--
-- Name: screenshots; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.screenshots ENABLE ROW LEVEL SECURITY;

--
-- Name: screenshots shots_owner_full; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY shots_owner_full ON public.screenshots USING ((EXISTS ( SELECT 1
   FROM public.apps a
  WHERE ((a.id = screenshots.app_id) AND (a.publisher_id = auth.uid()))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM public.apps a
  WHERE ((a.id = screenshots.app_id) AND (a.publisher_id = auth.uid())))));


--
-- Name: screenshots shots_public_read_via_listed_app; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY shots_public_read_via_listed_app ON public.screenshots FOR SELECT USING ((EXISTS ( SELECT 1
   FROM public.apps a
  WHERE ((a.id = screenshots.app_id) AND ((a.is_listed = true) OR (a.publisher_id = auth.uid()))))));


--
-- Name: app_versions versions_owner_full; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY versions_owner_full ON public.app_versions USING ((EXISTS ( SELECT 1
   FROM public.apps a
  WHERE ((a.id = app_versions.app_id) AND (a.publisher_id = auth.uid()))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM public.apps a
  WHERE ((a.id = app_versions.app_id) AND (a.publisher_id = auth.uid())))));


--
-- Name: app_versions versions_public_read_via_listed_app; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY versions_public_read_via_listed_app ON public.app_versions FOR SELECT USING ((EXISTS ( SELECT 1
   FROM public.apps a
  WHERE ((a.id = app_versions.app_id) AND ((a.is_listed = true) OR (a.publisher_id = auth.uid()))))));
...
--
-- Name: objects Allow authenticated upload trailers 6p6erc_0; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Allow authenticated upload trailers 6p6erc_0" ON storage.objects FOR SELECT TO authenticated USING (((bucket_id = 'app-media'::text) AND (auth.role() = 'authenticated'::text)));


--
-- Name: objects Allow authenticated upload trailers 6p6erc_1; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Allow authenticated upload trailers 6p6erc_1" ON storage.objects FOR UPDATE TO authenticated USING (((bucket_id = 'app-media'::text) AND (auth.role() = 'authenticated'::text)));


--
-- Name: objects Allow authenticated upload trailers 6p6erc_2; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Allow authenticated upload trailers 6p6erc_2" ON storage.objects FOR INSERT TO authenticated WITH CHECK (((bucket_id = 'app-media'::text) AND (auth.role() = 'authenticated'::text)));


--
-- Name: objects Allow authenticated upload trailers 6p6erc_3; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Allow authenticated upload trailers 6p6erc_3" ON storage.objects FOR DELETE TO authenticated USING (((bucket_id = 'app-media'::text) AND (auth.role() = 'authenticated'::text)));


--
-- Name: objects Allow authenticated uploads 13qpkip_0; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Allow authenticated uploads 13qpkip_0" ON storage.objects FOR INSERT TO authenticated WITH CHECK ((bucket_id = 'app-screenshots'::text));


--
-- Name: objects Allow authenticated uploads 6p6erc_0; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Allow authenticated uploads 6p6erc_0" ON storage.objects FOR INSERT TO authenticated WITH CHECK ((bucket_id = 'app-media'::text));


--
-- Name: objects Allow delete/update 13qpkip_0; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Allow delete/update 13qpkip_0" ON storage.objects FOR DELETE TO authenticated USING ((bucket_id = 'app-screenshots'::text));


--
-- Name: objects Allow delete/update 13qpkip_1; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Allow delete/update 13qpkip_1" ON storage.objects FOR UPDATE TO authenticated USING ((bucket_id = 'app-screenshots'::text));


--
-- Name: objects Allow logged-in users full access; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Allow logged-in users full access" ON storage.objects USING ((auth.role() = 'authenticated'::text));


--
-- Name: objects Allow public read 13qpkip_0; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Allow public read 13qpkip_0" ON storage.objects FOR SELECT USING ((bucket_id = 'app-screenshots'::text));


--
-- Name: objects Allow public read 6p6erc_0; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Allow public read 6p6erc_0" ON storage.objects FOR SELECT USING ((bucket_id = 'app-media'::text));


--
-- Name: objects Allow public read trailer 6p6erc_0; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Allow public read trailer 6p6erc_0" ON storage.objects FOR SELECT USING ((bucket_id = 'app-media'::text));


--
-- Name: objects Developer Write Own cwm12e_0; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Developer Write Own cwm12e_0" ON storage.objects FOR INSERT TO authenticated WITH CHECK (((bucket_id = 'developer-assets'::text) AND (auth.uid() IS NOT NULL)));


--
-- Name: objects Developer Write Own cwm12e_1; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Developer Write Own cwm12e_1" ON storage.objects FOR UPDATE TO authenticated USING (((bucket_id = 'developer-assets'::text) AND (auth.uid() IS NOT NULL)));


--
-- Name: objects Developer Write Own cwm12e_2; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Developer Write Own cwm12e_2" ON storage.objects FOR DELETE TO authenticated USING (((bucket_id = 'developer-assets'::text) AND (auth.uid() IS NOT NULL)));


--
-- Name: objects Public View cwm12e_0; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Public View cwm12e_0" ON storage.objects FOR SELECT USING ((bucket_id = 'developer-assets'::text));
...
--
-- Name: TABLE app_categories; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE developers; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE installs; Type: ACL; Schema: public; Owner: -
--

GRANT ALL ON TABLE public.installs TO anon;
GRANT ALL ON TABLE public.installs TO authenticated;
GRANT ALL ON TABLE public.installs TO service_role;


--
-- Name: SEQUENCE installs_id_seq; Type: ACL; Schema: public; Owner: -
--

GRANT ALL ON SEQUENCE public.installs_id_seq TO anon;
GRANT ALL ON SEQUENCE public.installs_id_seq TO authenticated;
GRANT ALL ON SEQUENCE public.installs_id_seq TO service_role;
...
--
-- Name: TABLE screenshots; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: SEQUENCE screenshots_id_seq; Type: ACL; Schema: public; Owner: -
--
...
\unrestrict DJ473HNJGl2fKtj4U80WSeoEc4fx3uqyulYTlbgieRMPVBleVPNKfaqfys9jzgC
